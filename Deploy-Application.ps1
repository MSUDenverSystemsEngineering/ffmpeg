...
Try {
	...
	[string]$appVendor = 'The FFmpeg Project'
	[string]$appName = 'FFmpeg'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$exitCode = Execute-Process -Path "$dirFiles\FFmpeg_v2.2.2_for_Audacity_on_Windows_64bit.exe" -Parameters "/verysilent" -WindowStyle "Hidden" -PassThru
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		$exitCode = Execute-Process -Path "$envProgramFiles\FFmpeg For Audacity\unins000.exe" -Parameters "/silent" -WindowStyle "Hidden" -PassThru
		If (($exitCode.ExitCode -ne "0") -and ($mainExitCode -ne "3010")) { $mainExitCode = $exitCode.ExitCode }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUFUN5WRoyx6y6bqMXw/pUny/2
# q7OgghHXMIIFbzCCBFegAwIBAgIQSPyTtGBVlI02p8mKidaUFjANBgkqhkiG9w0B
...
# MRYEFAHu2sr2LcwhgM2amq4EEqPP54TMMA0GCSqGSIb3DQEBAQUABIIBgEcB9Q5I
# ilmYqMOakL9Sljz8XgYbHb94Vz4jYeGgYvIo1trntr69W3NxxmUGCAem9L2jgD50
# 17CL79DFCy4K1s6lGm12kQpv4jFiWqp4FLK6vLPKX3XUri4dZhUx8ldL73JniZ9c
# zl1jSfNQr0ju6uSo1HLE3ytC/w8wiXUjaCOCKIINtxn48dmvlZ4b5yh6XMcI0M1G
# v7H948Evc2QUHPsNClmvNDMnf5VcbjtRMfdfA3oPO2Q/HqAdW4mn23ka206vgYLo
# 5DzpjRShza25JLolv43fW67giPw/neFHrIQzXRp4RIGjGQfznOmw9pUFZ9aaQPk6
# rTEN3yxBZGFoYCqc2kCaJSf3gkfe5ff4NKXRVE8FM7Xq39Fzc8uDV5NqRas2yTk8
# TMfgudEwVAVQAD6nrfs/qcOlphc/9+DhmGdXijIU+OjYM99Ke1RYRnmmTzKbjcmm
# bCcLwWJ/ZcpJdlK9dm6id7UE9yZlHxgJ9c+UuytC1shuQMaOJKUOxu9c9w==
